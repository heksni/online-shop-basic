            ...
            @foreach ($products as $product )
                    <div class="col-md-3">
                        <div class="card product-card">
                            <div class="product-image position-relative p-4">
                                <a href="" class="product-img"><img class="card-img-top"
                                        src="{{ asset('/uploads/product/small/'.$product->product_images->image) }}" alt="image here"></a>
                            ...
                            <div class="card-body text-center mt-3">
                                ...
                                <div class="price mt-2">
                                    ...
                                    <span class="h6 text-underline" {{ $product->compare_price ? '' : 'hidden'}}><del>${{ $product->compare_price }}</del></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="card product-card">
                                <div class="product-image position-relative">
                                    <a href="" class="product-img"><img class="card-img-top"
                                            src="{{ asset('uploads/product/small/'.$latest->product_images->image) }}" alt=""></a>
                                    <a class="whishlist" href="222"><i class="far fa-heart"></i></a>
                                ...
                                <div class="card-body text-center mt-3">
                                    ...
                                    <div class="price mt-2">
                                        ...
                                        <span class="h6 text-underline" {{ $product->compare_price ? '' : 'hidden'}}><del>${{ $latest->compare_price }}</del></span>
                                    </div>
                                </div>
                            </div>
                        </div>
